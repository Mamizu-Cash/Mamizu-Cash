...
export const Monospace: Story = {
  args: {
    children: "0x7f83b1657ff1fc53b92dc18148a1d65dfc2d4b1fa3d677284addd200126d9069",
    as: "code",
    variant: "mono",
    color: "secondary",
  },
...
export const TypographyScale: Story = {
  render: () => (
    ...
    >
      ...
      <Text variant="body">Body - Regular paragraph text for general content</Text>
      <Text variant="bodySmall">Body Small - Supporting text and descriptions</Text>
...
export const Alignment: Story = {
  render: () => (
    ...
    >
      ...
      <Text align="justify">
        Justify aligned text - This text is justified to stretch across the full width of the
...
export const Transformations: Story = {
  render: () => (
    ...
    >
      ...
      <Text transform="capitalize">capitalize each word text transformation</Text>
    </div>
  ),
  ...
  render: () => (
    ...
    >
      <div>
        ...
        <Text truncate>
          This is a very long text that should be truncated with an ellipsis when it exceeds the
          container width.
        </Text>
      </div>
      <div>
        ...
        <Text truncate={2}>
          This is a longer text that should be clamped to exactly two lines. The text will wrap to
          the second line and then be truncated with an ellipsis if it's still too long to fit.
        </Text>
      </div>
      <div>
        <Text variant="labelSmall" color="secondary">
        ...
        <Text truncate={3}>
          This is an even longer text that should be clamped to exactly three lines. The text will
          wrap to multiple lines as needed, but will be truncated after the third line if there's
          still more content that doesn't fit within the container.
        </Text>
      </div>
    </div>
  ),
...
export const CeremonyInfo: Story = {
  render: () => (
    ...
    >
      ...
      <Text variant="labelSmall" color="brand" transform="uppercase" align="center">
        STEP 2
      </Text>
      <Text variant="body" color="secondary" align="center">
        署名を見守っています...
