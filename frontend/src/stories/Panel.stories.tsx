...
import { Calendar, Link, QrCode, Shield } from "lucide-react";
...
export const AllPanelsShowcase: Story = {
  render: () => (
    ...
    >
      <div>
        ...
        <Panel size="small">
          <div style={{ textAlign: "center" }}>
            ...
            <div style={{ fontSize: "1rem", fontWeight: "600", color: "#74c0fc" }}>署名中</div>
          </div>
        </Panel>
      </div>

      <div>
        <h3 style={{ marginBottom: "1rem", color: "#374151" }}>Ceremony Info</h3>
        <Panel size="small">
          <div
            style={{
              display: "flex",
          ...
          >
            <div style={{ fontSize: "1rem", textAlign: "right", flex: "1" }}>田中 太郎</div>
            <div
              style={{
                width: "24px",
                height: "24px",
            ...
            <div style={{ fontSize: "1rem", textAlign: "left", flex: "1" }}>山田 花子</div>
          </div>
        </Panel>
      </div>

      <div>
        <h3 style={{ marginBottom: "1rem", color: "#374151" }}>Tech Carousel</h3>
        <Panel size="small">
          <div style={{ textAlign: "center" }}>
      ...
      <div>
        <h3 style={{ marginBottom: "1rem", color: "#374151" }}>Memory Showcase</h3>
        <Panel size="small">
          <div style={{ textAlign: "center" }}>
            <div
              style={{
