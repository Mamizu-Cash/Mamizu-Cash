      ...
      <div className="container mx-auto max-w-4xl px-4">
        <Card className="w-full border-0 bg-background/95 shadow-xl backdrop-blur">
          <CardHeader className="space-y-4 pb-8 text-center">
            <div className="mx-auto mb-4 flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-r from-primary to-accent">
              <Download size={40} className="text-white" />
            </div>
            <div className="space-y-2">
              <CardTitle className="bg-gradient-to-r from-primary to-accent bg-clip-text font-bold text-3xl text-transparent">
                Secure Withdrawal
              </CardTitle>
              ...
              {credentialStatus === "invalid" && (
                <div className="space-y-4">
                  ...
                  <AlertDescription className="text-destructive">
                    You need either a Mizuhiki Verified SBT or UNTI credential to withdraw these
                    funds.
                  </AlertDescription>
            ...
            <Button
              ...
              className={`w-full py-6 font-semibold text-lg transition-all ${
                credentialStatus !== "valid" || isWithdrawing
                  ? "cursor-not-allowed"
                  : "bg-gradient-to-r from-primary to-accent hover:scale-102 hover:from-primary/90 hover:to-accent/90 hover:shadow-lg"
              }`}
            >
              {isWithdrawing ? (
                <>
